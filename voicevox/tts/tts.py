...
from core.model_runtime.model_providers.voicevox.tts.sota_translation import (
    TTStranslation,
)
        ...
        try:
            sentences = list(
                self._split_text_into_sentences(
                    org_text=self.tts_translation.sota_translation(content_text),
                    pattern="。",
                ...
                for future in futures:
                    if future.result():
                        ...
                        segment = AudioSegment.from_file(
                            BytesIO(future.result()), format=audio_type
                        )
