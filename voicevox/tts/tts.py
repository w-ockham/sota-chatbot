...
from core.model_runtime.model_providers.voicevox.tts.sota_translation import sota_translation
...
class VoicevoxText2SpeechModel(TTSModel):
    ...
    def _tts_invoke(self, model: str, credentials: dict, content_text: str, voice: str) -> any:
        ...
        try:
            sentences = list(self._split_text_into_sentences(org_text=sota_translation(content_text), 
                                                             pattern='。',
